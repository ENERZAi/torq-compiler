...
#define RF_BMSK_LSH(reg, field, val)                                                               \
    (((val) & ((1 << REG_FIELD_BITS__SYNPU_##reg##_REGS_##field) - 1))                             \
     << REG_FIELD_POS__SYNPU_##reg##_REGS_##field)
#define RF_FMSK_RSH(reg, field, val)                                                               \
    (((val) >> REG_FIELD_POS__SYNPU_##reg##_REGS_##field) &                                        \
     ((1 << REG_FIELD_BITS__SYNPU_##reg##_REGS_##field) - 1))
